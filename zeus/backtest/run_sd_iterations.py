...
VARIANTS: list[VariantConfig] = [
    ...
    VariantConfig(
        label              = "V42 · zone≥5.5 wy≥5.9 R:R=2.5 [R9 best]",
        **_WW,
    ...
    # ── Round 10 — refine around V42 ─────────────────────────────────────────
    # V42 breakthrough: zone≥5.5, wy≥5.9, R:R=2.5 → 57 sigs, 47.4% WR,
    # +37.5R, $4,092, DD=5.1%. New zone-5.5 trades add 8W/4L = 66.7% WR.
    # Explore: higher R:R (back to 3.0?), lower zone floor (5.0?),
    # fine-tuned wy (5.85, 5.95), shorter cooldown for more signals.
    VariantConfig(
        label              = "V46 · zone≥5.5 wy≥5.9 R:R=3.0",
        **_WW,
        min_zone_score     = 5.5, min_wyckoff_score=5.9,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 25,  daily_cap=3,
    ...
    VariantConfig(
        label              = "V47 · zone≥5.5 wy≥5.9 cool15 R:R=2.5",
        **_WW,
        min_zone_score     = 5.5, min_wyckoff_score=5.9,
        trend_slope_lb     = 6,   use_price_above_ema=False,
    ...
    VariantConfig(
        label              = "V48 · zone≥5.5 wy≥5.85 R:R=2.5",
        **_WW,
        min_zone_score     = 5.5, min_wyckoff_score=5.85,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 25,  daily_cap=3,
        risk_reward        = 2.5,
    ),
    VariantConfig(
        label              = "V49 · zone≥5.5 wy≥5.95 R:R=2.5",
        **_WW,
        min_zone_score     = 5.5, min_wyckoff_score=5.95,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 25,  daily_cap=3,
        risk_reward        = 2.5,
    ),
    VariantConfig(
        label              = "V50 · zone≥5.0 wy≥5.9 R:R=2.5",
        **_WW,
    ...
    VariantConfig(
        label              = "V51 · zone≥5.5 wy≥5.9 R:R=2.0",
        **_WW,
        min_zone_score     = 5.5, min_wyckoff_score=5.9,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 25,  daily_cap=3,
    ...
    VariantConfig(
        label              = "V52 · zone≥5.5 wy≥5.9 cool15 R:R=3.0",
        **_WW,
        min_zone_score     = 5.5, min_wyckoff_score=5.9,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 15,  daily_cap=4,
