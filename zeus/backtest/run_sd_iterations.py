...
VARIANTS: list[VariantConfig] = [
    ...
    VariantConfig(
        label              = "V35 · zone≥6.0 wy≥6.0 cool15 R:R=2.5 [R8 best]",
        **_WW,
    ...
    # ── Round 9 — fine-grained wy threshold scan + lower zone floor ──────────
    # V35 is the sweet spot: 41 sigs, 41.5% WR, +18.5R, DD=5.8%.
    # Bottleneck = wy≥6.0 gate: only ~41 patterns qualify per year.
    # Hypothesis A: wy in [5.75, 5.8, 5.9] adds 5-15 sigs, WR stays ≥40%.
    # Hypothesis B: zone≥5.5 (lower floor) opens new zones → more wy≥6.0 signals.
    VariantConfig(
        label              = "V38 · zone≥6.0 wy≥5.9 R:R=2.5",
        **_WW,
        min_zone_score     = 6.0, min_wyckoff_score=5.9,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 25,  daily_cap=3,
        risk_reward        = 2.5,
    ),
    VariantConfig(
        label              = "V39 · zone≥6.0 wy≥5.8 R:R=2.5",
        **_WW,
        min_zone_score     = 6.0, min_wyckoff_score=5.8,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 25,  daily_cap=3,
        risk_reward        = 2.5,
    ),
    VariantConfig(
        label              = "V40 · zone≥6.0 wy≥5.75 R:R=2.5",
        **_WW,
        min_zone_score     = 6.0, min_wyckoff_score=5.75,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 25,  daily_cap=3,
        risk_reward        = 2.5,
    ),
    VariantConfig(
        label              = "V41 · zone≥5.5 wy≥6.0 R:R=2.5",
        **_WW,
        min_zone_score     = 5.5, min_wyckoff_score=6.0,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 25,  daily_cap=3,
        risk_reward        = 2.5,
    ),
    VariantConfig(
        label              = "V42 · zone≥5.5 wy≥5.9 R:R=2.5",
        **_WW,
    ...
    VariantConfig(
        label              = "V43 · zone≥5.5 wy≥5.8 R:R=2.5",
        **_WW,
        min_zone_score     = 5.5, min_wyckoff_score=5.8,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 25,  daily_cap=3,
        risk_reward        = 2.5,
    ),
    VariantConfig(
        label              = "V44 · zone≥6.0 wy≥5.9 cool15 R:R=2.5",
        **_WW,
        min_zone_score     = 6.0, min_wyckoff_score=5.9,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 15,  daily_cap=4,
    ...
    VariantConfig(
        label              = "V45 · zone≥6.0 wy≥5.8 cool15 R:R=2.5",
        **_WW,
        min_zone_score     = 6.0, min_wyckoff_score=5.8,
        trend_slope_lb     = 6,   use_price_above_ema=False,
        signal_cooldown    = 15,  daily_cap=4,
