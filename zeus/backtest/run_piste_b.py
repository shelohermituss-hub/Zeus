"""
Piste B — 1M candle pattern filter + extended TP ladder.

Reference: V2A_L3 (score=3, SL=6, approach+sweep lb=3, scalp() TP)
           PF=1.94, 32 trades, WR=40.6%
...
Usage
-----
    python -m zeus.backtest.run_piste_b
"""
...
# ── Variant definitions ───────────────────────────────────────────────────────
# Each variant carries its TP config key: "scalp" or "mtf_smc"
VARIANTS: list[dict] = [
    {
...
def main() -> None:
    ...
    out_path = RESULTS_DIR / "piste_b_xauusd_2026.json"
